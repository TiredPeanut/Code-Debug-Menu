...
public class InspectionListItem extends ObjectSelectionList.Entry<InspectionListItem> {
    ...
    public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pHovering, float pPartialTick) {
        init();
        pGuiGraphics.drawString(_parent.getMinecraftInstance().font, _title, pLeft + 38, pTop + 5, 65535);
        ...
        pGuiGraphics.drawString(_parent.getMinecraftInstance().font, _description, (int) scaledY + 55, (int)scaledX + 21, 65535);
        poseStack.popPose();
    }
